...
<body class="bg">
    ...
    <div class="container">
        <div class="alert alert-secondary">
            <h1 class="tituloEtapa">Etapa 5</h1> <br>
            ...
            <button class="btn btn-success" id="botaoContinuar" onclick="window.sessionStorage.setItem('page','11'); window.location.href = 'impExaMascHumFem2.php'">Começar</button>
        </div>
    </div>
