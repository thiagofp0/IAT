...
<body class="bg">
    ...
    <div class="container">
        <div class="alert alert-secondary">
            <h1 class="tituloEtapa">Etapa 2</h1> <br>
            ...
            <button class="btn btn-success" id="botaoContinuar" onclick="window.sessionStorage.setItem('page','5'); window.location.href = 'impMascFem.php'">Começar</button>
        </div>
    </div>
