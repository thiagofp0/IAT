    ...
    <script type="text/javascript">
        ...
        function mudaPalavra(){
            if(indice >= palavras.length){
                ...
                tmp3 = (Date.now() - tempoInicio);
                window.sessionStorage.setItem('tmp3', tmp3);
...
<body class="bg">
    ...
    <div class="box container" id="boxQuest">
        ...
        <p>Aperte a tecla <span class="tecla">E</span> para itens que pertencem ao grupo <strong>Feminino</strong>.</p>
        <p>Aperte a tecla <span class="tecla">I</span> para itens que pertencem ao grupo <strong>Masculino</strong>.</p>
