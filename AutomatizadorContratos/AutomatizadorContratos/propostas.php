...
<body>
    ...
    <p style= "margin-left:10px">Bem vindo ao Automatizador de Propostas da Locus Iuris Consultoria Jurídica!</p>
    <p style= "margin-left:10px">Para iniciar, selecione os serviços que estarão presentes na proposta:</p>
    <form method="POST" action="proposta_tabela.php" onsubmit="return validar()">
    <?php
